...
<i18n>
{
  ...
  "en": {
    ...
    "県庁来庁者数の推移": "Trend in the number of TMG visitors"
  },
  "zh-cn": {
    "検査陽性者の状況": "确诊案例状况",
    "陽性患者数": "确诊人数",
    ...
    "県営地下鉄の利用者数の推移": "県营地下铁搭乘人数趋势",
    "県庁来庁者数の推移": "东京県厅来访人数推移"
  },
  "zh-tw": {
    "検査陽性者の状況": "確診案例狀況",
    "陽性患者数": "確診人數",
    ...
    "県営地下鉄の利用者数の推移": "県營地下鐵搭乘人數走勢",
    "県庁来庁者数の推移": "東京県廳來訪人數走勢"
  },
  "ko": {
    "検査陽性者の状況": "확진자의 현황",
    "陽性患者数": "확진자 수",
    ...
    "県営地下鉄の利用者数の推移": "도에이 지하철 의 예상 승객 수",
    "県庁来庁者数の推移": "도쿄도 청사 방문자 수"
  },
  "ja-basic": {
    ...
    "県営地下鉄の利用者数の推移": "とえいちかてつを つかった ひとの かず",
    "県庁来庁者数の推移": "議事堂（ぎじどう）に 来（き）た 人（ひと）の 合計（ごうけい）"
  }
}
</i18n>
...
export default {
  ...
  head() {
    ...
    const description =
      this.updatedAt +
      ' 更新 | ' +
      '当サイトは新型コロナウイルス感染症（COVID-19）に関する最新情報を提供するために、東京県が開設したものです。'
    ...
    return {
      ...
      meta: [
        ...
        },
        {
          hid: 'og:title',
          property: 'og:title',
          content: this.title + ' | 東京県 新型コロナウイルス感染症対策サイト'
        },
        {
          hid: 'description',
          name: 'description',
